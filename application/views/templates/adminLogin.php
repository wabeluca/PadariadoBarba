            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">Padaria do Barba Login!</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="/login/validalogin">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Não possui conta? <a href="<?php echo base_url();?>login/registroHome">Crie aqui!</a></p>
                    </div>
                  </form>
