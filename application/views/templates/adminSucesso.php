...
<body>
  ...
  <main>
    <div class="container">
        <div class="col-md-12" style="margin-top: 400px; margin-left: 400px;">
            <label for="inputName5" class="form-label">Salvo com sucesso</label>
            <br/>
            <a class="btn btn-success" href="<?php echo base_url();?>usuario/RegistrarSenha">Cadastre sua Senha</a>
        </div>
    </div>
  </main><!-- End #main -->
